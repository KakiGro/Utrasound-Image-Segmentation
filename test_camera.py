...
def main(camera_source, checkpoint_path):
    ...
    # Open the USB camera. Using "/dev/video0" as the source.
...
# Use "/dev/video0" as the camera source
main("/dev/video0", "./Checkpoints/UltimaVersion/my_checkpoint.pth.tar")
